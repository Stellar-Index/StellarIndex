...
| **Showcase domain** | `stellarindex.io` (the explorer / showcase). Customer dashboard lives at the separate `app.stellarindex.io`; see [`web/dashboard/README.md`](../../web/dashboard/README.md). | CNAME → Cloudflare Pages OR A → r1; Cloudflare proxied (orange cloud) either way. Single-vendor CDN story. |
