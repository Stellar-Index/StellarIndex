...
| L2.6 | Multi-factor confidence score on every published price — math primitive shipped; orchestrator wire-up follows | Wk 6 | ~2 days | L2.5 | L3.1 | `internal/aggregate/confidence` | 🟠 |
