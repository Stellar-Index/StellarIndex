...
| Upshift | lake bespoke-symbol census (no factory) | ✅ Gated (curated 2-vault allowlist, 2026-09-09) — tokenized yield vaults, no price, excluded from VWAP | [upshift.md](upshift.md) |
