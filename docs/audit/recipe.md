...
|---|---|---|---|
| **audit-2026-06-30** (CS-###) | First cold whole-system pass: money serve paths, SSE, CF edge functions, dashboard/auth, tenant isolation, root services | `docs/audit-2026-06-30/` (coverage tracker + per-area files) | Source of the CS-### ids still cited throughout this file. Its Highs clustered in the newest surface (SSE, CF edge) — the origin of RFC-6. |
...
| **audit-2026-07-03-rfp-compliance** | RFP/contractual compliance claims | `docs/audit-2026-07-03-rfp-compliance/README.md` | Narrow, one-off. Re-run only if the RFP claims change. |
