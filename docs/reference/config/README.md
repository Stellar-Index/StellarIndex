...
| `api.dashboard.base_url` | `string` | _(required)_ | — | Absolute URL of the customer dashboard SPA (e.g. https://app.stellarindex.io). The magic-link callback URL embedded in emails is {base_url}/auth/callback?token=<plaintext>. |
