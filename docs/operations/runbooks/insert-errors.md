...
- `stellarindex_source_insert_errors_total{source=...,kind=trade|oracle}` rises above 6/min sustained.
...
curl -s http://api:9464/metrics |
  grep stellarindex_source_insert_errors_total
