...
| Runbook routing | All three burn tiers' `runbook_url` lands on this page. Per-tier detail: [slo-latency-burn-fast](slo-latency-burn-fast.md), [slo-latency-burn-medium](slo-latency-burn-medium.md), [slo-latency-burn-slow](slo-latency-burn-slow.md). |
