...
- `stellarindex_price_staleness_seconds{asset=...} > 120` sustained 5 min.
...
ssh root@<host> "curl -s http://localhost:9465/metrics | grep stellarindex_aggregator_vwap_writes_total"
```
