...
| `ratesengine_ingest_gap_detected` | `ratesengine_ingest_gap_max_size_ledgers > 1000` per source | sustained 15 min | **P1** | [ingest-gap-detected](runbooks/ingest-gap-detected.md) |
