...
| `stellarindex_dex_nonstandard_decimals_detected` | `sum by (source, asset) (stellarindex_dex_trade_nonstandard_decimals_total)` | > 0 for ≥ 5 min | informational | [dex-nonstandard-decimals](runbooks/dex-nonstandard-decimals.md) |
