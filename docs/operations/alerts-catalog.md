...
| `stellarindex_customer_webhook_delivery_exhausted` | `rate(stellarindex_customer_webhook_delivery_attempts_total{outcome="exhausted"}[1h])` | > 0 for ≥ 1h | ticket | [customer-webhook-delivery-failing](runbooks/customer-webhook-delivery-failing.md) |
