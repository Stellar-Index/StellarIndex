...
| 1.7 | ~~**Test nets are a release and three migrations behind again.**~~ **STALE — RESOLVED, measured 2026-09-08.** All three hosts are level: r1, testnet (192.168.122.10) and futurenet (192.168.122.20) each report `v0.63.0 (2026-09-07T08:49:40Z)` and `schema_migrations` max **155**. The row described a real gap on its date and was carried after it closed. | — |
