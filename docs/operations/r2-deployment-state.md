...
| stellarindex-indexer | {{TBD}} | Reads MinIO for galexie-live + AWS S3 for galexie-archive. |
| stellarindex-aggregator | {{TBD}} | Standby until Patroni elects R2 leader. |
| stellarindex-api | {{TBD}} | Serves regional traffic via `api-r2.stellarindex.io`. |
...
- `api-r2.stellarindex.io` → R2's HAProxy frontend IP / ALB
