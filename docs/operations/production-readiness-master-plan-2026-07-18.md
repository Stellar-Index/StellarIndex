...
- **✅ `seed-sep41-genesis` DONE + confirmed** — 39/39 SEP-41 contracts seeded (16 non-zero baselines) → `supply refresh: compute failed` errors dropped to **0** (supply_refresh_error_dominant CAUSE fixed; alert decays on its rate window).
