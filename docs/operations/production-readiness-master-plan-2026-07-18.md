...
- **⚠️ URGENT `[OP]`:** create `R1_INVENTORY_B64` GitHub secret before the next ansible-drift run (r1.yml is untracked-local by design; workflow red until the secret exists).
