...
> **Superseded, and kept only as a record of the shape (#378,
> 2026-09-09).** Proof reports are now GENERATED by
> [`scripts/ci/render-sla-proof.sh`](../../scripts/ci/render-sla-proof.sh)
> from the k6 `--summary-export`, and committed by the weekly
> workflow. Do not hand-fill this form: a hand-entered number is a
> number no export backs, and the generated report carries
> provenance (target, run window, method, commit, k6 version, export
