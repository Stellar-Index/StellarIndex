...
export interface paths {
    ...
    "/assets/{asset_id}": {
         ...
         *     resolution**: every classic asset carries a unique public
         *     slug (`lower(code)-<first 8 of issuer>`, e.g.
         *     `usdt-gcqtgzqq`), so `/assets/usdt-gcqtgzqq` serves the same
         *     per-Stellar-asset detail as its canonical `USDT-G…` form.
         *     A path that is none of the above returns 400.
         */
        get: {
            parameters: {
                query?: never;
