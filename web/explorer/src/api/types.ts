...
export interface components {
  schemas: {
    ...
    AccountPosition: {
       ...
       */
      amount_semantics:
        | 'net_underlying_at_event_time'
        | 'shares'
        | 'stateful_current'
        | 'signed_delta_sum_unconfirmed_unit';
    ...
    ProtocolRow: {
      ...
      /** @enum {string} */
      category:
        'dex' | 'amm' | 'lending' | 'yield' | 'bridge' | 'oracle' | 'token';
      description: string;
      /**
       * Format: int64
    ...
    RWARefusal: {
      ...
      reason:
        ...
        | 'issuer_scam_flagged'
        | 'issuer_not_independently_recognised'
        | 'no_real_world_instrument_basis';
      assets: number;
    };
    SDEXOrderBook: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
           ...
           */
          'application/json':
            | components['schemas']['AssetEnvelope']
            | components['schemas']['GlobalAssetEnvelope'];
        };
      };
      400: components['responses']['BadRequest'];
      404: components['responses']['NotFound'];
    ...
    responses: {
      ...
      200: {
        ...
        content: {
           ...
           */
          'application/json':
            | components['schemas']['OHLCEnvelope']
            | components['schemas']['OHLCSeriesEnvelope'];
        };
      };
      400: components['responses']['BadRequest'];
      /**
    ...
    requestBody: {
      content: {
        'application/json': {
           ...
           */
          tier?:
            'free' | 'partner' | 'starter' | 'pro' | 'business' | 'enterprise';
          /**
