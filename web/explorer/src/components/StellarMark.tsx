// StellarMark — the official Stellar network symbol (the two interlocked
// arcs), rendered in currentColor so it follows the surrounding ink/theme
// tokens the way stellar.org's own mark renders black-on-light /
// white-on-dark. Path is the canonical Stellar brand mark (via the
// Simple Icons distribution of SDF's logo, 24×24 viewBox).
