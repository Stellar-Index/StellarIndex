...
// comment; `{/* LEGAL-REVIEW */}` is the equivalent and is stripped from
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-10 px-6 py-10">
      ...
      >
        ...
        {/* LEGAL-REVIEW: "not financial advice" disclaimer wording. */}
        <p>
      ...
      >
        ...
        <DefList
          rows={[
            ...
            {
              term: 'Free account',
              // LEGAL-REVIEW: self-service keys carry an explicit per-key limit of
        ...
        {/* LEGAL-REVIEW: minimum age / capacity to contract clause. */}
        <p>
      ...
      >
        {/* LEGAL-REVIEW: the data-licence grant and attribution requirement
      ...
      >
        {/* LEGAL-REVIEW: warranty disclaimer — jurisdiction-specific
      ...
      >
        {/* LEGAL-REVIEW: liability cap. Because the Service is free, the
        ...
        <p>
          ...
          <Placeholder>
            100 in the governing currency — TO BE CONFIRMED
          </Placeholder>
      ...
      >
        ...
        {/* LEGAL-REVIEW: notice period for terms changes (draft: 14 days,
      ...
      >
        {/* LEGAL-REVIEW: governing law + venue. The operating entity and
            its jurisdiction are not recorded anywhere in the repo, so the
            placeholder is rendered visibly rather than guessed. */}
        <p>
          These terms are governed by the laws of{' '}
          <Placeholder>JURISDICTION — TO BE CONFIRMED</Placeholder>, and the
          courts of <Placeholder>JURISDICTION — TO BE CONFIRMED</Placeholder>{' '}
