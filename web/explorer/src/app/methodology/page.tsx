  ...
  return (
    <div className="mx-auto max-w-4xl space-y-10 px-6 py-10">
      ...
      >
        ...
        <p>
          Outliers are filtered before the average using a per-asset statistical
          baseline (
          <ADRRef id="0019" />
          ). A trade that prints more than N MAD-deviations from the rolling
          median is dropped from that bucket; multiple consecutive outliers from
          the same source flag the source as &ldquo;misbehaving&rdquo; and mute
          its contribution.
        </p>
      </Section>
      ...
      >
        ...
        <ul className="ml-5 list-disc space-y-1">
          ...
          <li>
            The aggregator maps the pegged stablecoins to their fiat at VWAP
            compute time: USDT, USDC, DAI, PYUSD, USDP → USD; EURC, EUROC, EUROB
            → EUR; MXNe → MXN.
          </li>
          <li>
            <strong>
