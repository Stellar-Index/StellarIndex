    ...
    return (
      <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <div className="flex justify-center gap-3">
          ...
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 rounded-md border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 hover:border-brand-500 hover:text-brand-600"
          >
            Create account
          </Link>
        </div>
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md border border-slate-200 px-3 py-1.5 text-xs text-slate-600 hover:border-slate-400 hover:text-slate-900"
        >
      ...
      {mintedKey && (
        <div className="space-y-3 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm">
          ...
          <div className="flex items-center gap-2 rounded-md bg-white p-2 font-mono text-xs">
      ...
      <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        {showMintForm && (
          <form onSubmit={handleMint} className="space-y-2 border-b border-slate-200 p-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                required
                className="flex-1 rounded-md border border-slate-200 bg-white px-2 py-1 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
              />
              <button
                type="submit"
  ...
  if (!confirming) {
    return (
      <button
        ...
        className="rounded-md border border-slate-200 px-2 py-1 text-[11px] text-slate-600 hover:border-rose-400 hover:text-rose-600"
      >
        Revoke
      </button>
    );
