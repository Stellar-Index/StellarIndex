...
const ORACLES: OracleEntry[] = [
  {
    ...
    discoveryDoc:
      'https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/oracles/reflector.md',
  },
  {
    name: 'Reflector — CEX',
  ...
  },
  {
    ...
    discoveryDoc:
      'https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/oracles/redstone.md',
  },
  {
    name: 'Band',
    source: 'band',
    ...
    discoveryDoc:
      'https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/oracles/band.md',
  },
];
