...
const DEXES: DexEntry[] = [
  {
    ...
    discoveryDoc:
      'https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/dexes-amms/soroswap.md',
  },
  {
    name: 'Phoenix',
    source: 'phoenix',
    ...
    discoveryDoc:
      'https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/dexes-amms/phoenix.md',
  },
  {
    name: 'Aquarius',
    source: 'aquarius',
    ...
    discoveryDoc:
      'https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/dexes-amms/aquarius.md',
  },
  {
    name: 'SDEX',
    source: 'sdex',
    ...
    discoveryDoc:
      'https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/dexes-amms/sdex.md',
  },
  {
    name: 'Comet',
    source: 'comet',
    ...
    discoveryDoc:
      'https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/dexes-amms/comet.md',
  },
];
