...
//
//   rate(stellaratlas_cross_region_divergences_total[10m]) > 0
//   rate(stellaratlas_cross_region_fetch_errors_total[5m])  > 0.1
//
	...
	exp := &crossRegionExporter{
		checksTotal: prometheus.NewCounterVec(
			prometheus.CounterOpts{
				Name: "stellaratlas_cross_region_checks_total",
		...
		divergences: prometheus.NewCounterVec(
			prometheus.CounterOpts{
				Name: "stellaratlas_cross_region_divergences_total",
		...
		fetchErrors: prometheus.NewCounterVec(
			prometheus.CounterOpts{
				Name: "stellaratlas_cross_region_fetch_errors_total",
		...
		checkErrors: prometheus.NewCounterVec(
			prometheus.CounterOpts{
				Name: "stellaratlas_cross_region_check_errors_total",
		...
		lastRunGauge: prometheus.NewGauge(
			prometheus.GaugeOpts{
				Name: "stellaratlas_cross_region_last_run_timestamp_seconds",
				Help: "Unix time of the last completed check sweep.",
			},
		),
		inFlight: prometheus.NewGauge(
			prometheus.GaugeOpts{
				Name: "stellaratlas_cross_region_check_in_flight",
