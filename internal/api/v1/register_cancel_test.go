...
func (cancelTestKeyStore) CountActiveForAccount(_ context.Context, _ uuid.UUID) (int, error) {
	return 0, nil
}

func (cancelTestKeyStore) ListActiveForAccount(_ context.Context, _ uuid.UUID) ([]platform.APIKey, error) {
	return nil, nil
}
