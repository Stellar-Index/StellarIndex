...
--     2. Parallel backfill. `stellarindex-ops backfill -parallel N`
...
--
--   - `stellarindex-ops seed-soroswap-pairs` — initial bootstrap;
...
COMMENT ON TABLE soroswap_pairs IS
    ...
    'decoder. Seeded by stellarindex-ops seed-soroswap-pairs and '
