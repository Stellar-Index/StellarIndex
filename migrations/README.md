...
| 0028 | [`0028_create_fx_quotes.up.sql`](0028_create_fx_quotes.up.sql) | `fx_quotes` hypertable — long-form persisted Massive / ECB / ExchangeRatesApi FX history backing `/v1/chart` fiat:fiat past 7d |
